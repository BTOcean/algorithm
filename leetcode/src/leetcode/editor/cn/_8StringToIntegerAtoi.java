...
//
//
// Related Topics 字符串 👍 1771 👎 0

/**
* @author xj
* @version 1.0
* @Date 2023-12-05 23:15:33
**/
...
class Solution {
	public int myAtoi(String s) {
		//meaningless init res
		Integer res = 0;
		s = s.trim();
		char[] chars = s.toCharArray();
		int i = 0;
		// If true, the final result is negative
		boolean flagOfNOrP = true;
		...
		try {
			...
			return flagOfNOrP ? Integer.MAX_VALUE : Integer.MIN_VALUE;
		}

		return flagOfNOrP ? res : -res;
	}
}
